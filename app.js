...
function chart(canvas, data) {
  ...
  yAxis(context, yMin, yMax);
  xAxis(context, xData, xRation);
...
function line(context, coords, { color }) {
  // start drawing
  context.beginPath();
...
function yAxis(context, yMin, yMax) {
...
function xAxis(context, data, xRation) {
  const labelsCount = 6;
